...
function setData(){
    ...
    right_p.innerHTML = "<img src='img/portrait/"+ rightab[0] +".png' alt=''>";
    right_I.innerHTML = "<img src='img/ingame/"+ rightab[0] +".png' alt=''>";
    left_p.innerHTML = "<img src='img/portrait/"+ leftab[0] +".png' alt=''>";
    left_I.innerHTML = "<img src='img/ingame/"+ leftab[0] +".png' alt=''>";
